...
este é o form cad veiculo de dentro do dir do arma, não do /dash!!
essa page vai ser acionada após o sumbit do user no arma.
ela é o form do cad user!
ou seja, quando o cara clicar no botão do cadastro, essa page recebe os inputs do arma, cadastra o cara no banco e, depois, mostra o cad do veículo
...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="http://192.168.1.15/tcc/dash/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="../assets/img/favicon.png">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <title>
    Now UI Dashboard by Creative Tim
    <?php
    include("cad-vei-func.php");
    ?>
  </title>
  ...
  <!-- CSS Files -->
  <link href="http://192.168.1.15/tcc/dash/assets/css/bootstrap.min.css" rel="stylesheet" />
  <link href="http://192.168.1.15/tcc/dash/assets/css/now-ui-dashboard.css?v=1.5.0" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="http://192.168.1.15/tcc/dash/assets/demo/demo.css" rel="stylesheet" />
</head>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Cadastre Seu Veículo, <?php echo($_SESSION['nome']);?></h5><!-- nome do candango -->
