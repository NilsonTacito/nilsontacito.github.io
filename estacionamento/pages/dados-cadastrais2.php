...
include("proc-consulta-gestor.php");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form action="proc-update-gestor.php" method="POST">
                 <div class="row"><!--tem que fazero botão de submit lá embaixo -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="placa_veiculo" type="text" class="form-control" placeholder=<?php echo $ret_rzsocial; ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
