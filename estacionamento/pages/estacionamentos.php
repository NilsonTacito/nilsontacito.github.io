<!--
Página de integração com o Google Maps, para demonstração dos estacionamentos
-->
<?php
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="content">
        ...
        <div class="offset-top-25"><!-- tirado do Arma, melhorar -->
          <form method="POST" action="cadastrar-estacionamento.php"> 
          <button class="button button-block button-primary" type="submit">Adicionar estacionamento</button>
        </div>
        </form>
        <div class="offset-top-25"><!-- tirado do Arma, melhorar -->
