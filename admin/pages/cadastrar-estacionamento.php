                ...
                <form>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="xx" value="xy">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group"><!-- ver input type -->
                        <label for="exampleInputEmail1">Total de vagas (motos)</label>
                        <input type="email" class="form-control" placeholder="yx">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" placeholder="Company" value="Ex: Quitanda 55 Park">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Cidade</label>
                        <input type="text" class="form-control" placeholder="Rio de Janeiro" value="Mike">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>CEP</label>
                        <input type="number" class="form-control" placeholder="248080040">
                      </div>
                    </div>
                  </div>
