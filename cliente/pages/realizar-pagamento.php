                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php
                          ...
                          if(!empty($calc_diaria_carro)){
                            ...
                            echo(number_format((float)$total_carro, 2, '.', '') . '$' . '<input type="number" name="preco-carro" value="' . number_format((float)$total_carro, 2, '.', '')  . '"/>');
                          }
                          ...
                          if(!empty($calc_diaria_moto)){
                            ...
                            echo(number_format((float)$total_moto, 2, '.', '') . '$' . '<input type="number" name="preco-moto" value="' . number_format((float)$total_moto, 2, '.', '')  . '"/>');
                          }
                        }                   
                        ?>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-right"><a  class="btn btn-round btn-primary">Realizar Pagamento</a> </td>
                      </tr>                      
                    </tbody>
                  </table>
                </div>
