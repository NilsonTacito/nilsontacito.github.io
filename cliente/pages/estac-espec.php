          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <p class="category"> <?php //echo $ck; ?> </p> <!--teste -->
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <?php
                  $query00 = "SELECT name, address, vg_carro, vg_moto FROM markers WHERE id = '{$ck}';";
                  $resultado00 = mysqli_query($conn, $query00);
                  ?>
                  <table class="table"><!-- Alterar para informar que não há dados caso nenhuma reserva tenha sido feita antes --> 
                    ...
                    <tbody>
                    <?php while ($teste00 = mysqli_fetch_array($resultado00, MYSQLI_ASSOC)) {?> <!--  meu erro estava sendo usar $conn->fetch_array() sem parâmetro -->
                      <tr>
                        <td> <!-- Total, ocupadas, reservadas-->
                          <?php //echo $_SESSION['name']; ?>
                          <?php echo $teste00['name']; ?>
                        </td>
                        <td>
                          <?php echo $teste00['address']; ?>                        
                        </td>                        
                        <td> <!-- Total, ocupadas, reservadas-->
                          <?php echo $teste00['vg_carro']; ?>
                        </td>
                        <td>
                          <?php echo $teste00['vg_moto']; ?>                         
                        </td>
                      </tr>
                      <?php break;} ?>
