...
$rows_update_vagas_disp = mysqli_num_rows($res_update_vagas_disp);//o num rows deve estar errado, funciona até aqui
    if($rows_update_vagas_disp == 1) {
