...
if(!empty($res_vei0)){//insert
    ...
    $query_rsv_0="INSERT INTO reserva (rsv_data, fk_rsv_estac_id, fk_rsv_vei_placa, rsv_hora) VALUES ('{$res_data}', '{$cookie_id_estac}', '{$res_vei0}', '{$res_hora}');";
    ...
    if(($res_update_carro_disp_0 != null) or ($res_update_moto_disp_0 != null)){ //SELECT rsv_id FROM reserva WHERE rsv_data='31-05-21' and fk_rsv_vei_placa='LIC5886' and fk_rsv_estac_id='1', usar num rows
...
if(!empty($res_vei1)){
    $query_rsv_2="UPDATE reserva SET fk_rsv_vei_placa_1 ='{$res_vei2}' WHERE rsv_id='{$rsv_id}';";
...
if(!empty($res_vei3)){
    $query_rsv_3="UPDATE reserva SET fk_rsv_vei_placa_1 ='{$res_vei3}' WHERE rsv_id='{$rsv_id}';";
    ...
    if($res_rsv_3 != null){
        ...
        if(!empty($res_tipo_vei_placa_3)){
            $ret_tipo_vei_placa_3 = mysqli_fetch_array($res_tipo_vei_placa_3, MYSQLI_ASSOC);
            $tipo_vei_placa_3 = $ret_tipo_vei_placa_3['vei_tipo'];
        
            //usar case aqui??
            switch($tipo_vei_placa_3){
                case "carro" :
...
if(!empty($res_vei4)){
    $query_rsv_4="UPDATE reserva SET fk_rsv_vei_placa_1 ='{$res_vei4}' WHERE rsv_id='{$rsv_id}';";
    ...
    $res_get_mov_vaga4 = mysqli_query($conn, $qry_get_mov_vagas1);
    ...
    if($res_rsv_4 != null){
        ...
        if(!empty($res_tipo_vei_placa_4)){
            $ret_tipo_vei_placa_4 = mysqli_fetch_array($res_tipo_vei_placa_4, MYSQLI_ASSOC);
            $tipo_vei_placa_4 = $ret_tipo_vei_placa_4['vei_tipo'];
        
            //usar case aqui??
            switch($tipo_vei_placa_4){
                case "carro" :
                    $mvg_carro_disp_4 = $ret_mvg_carros_disp4 + 1;
                    $qyr_update_carro_disp_4 = "UPDATE mov_vagas SET mvg_ocp_carro='{$mvg_carros_disp_4}' WHERE mvg_id = '{$ret_proc_mvg_id}';";
                    $res_update_carro_disp_4 = mysqli_query($conn,$qyr_update_carro_disp_4);//Query OK, 1 row affected (0.16 sec)
                        /* testar depois
                        $rows_update_carro_disp_0 = mysqli_num_rows($res_update_carro_disp_0);
                        if($rows_update_carro_disp_0 == 1){
                        }*/
                ...
                case "moto" :
                    $mvg_moto_disp_4 = $ret_mvg_motos_disp4 + 1;
