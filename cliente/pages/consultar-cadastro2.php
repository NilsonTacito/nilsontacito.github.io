              ...
              <div class="card-body"> <!-- teste de retorno de dados do banco realizado com sucesso -->
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled="" placeholder= <?php echo $ret_doc_cliente; ?>>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email" class="form-control" disabled="" placeholder= <?php echo $ret_email_cliente ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" placeholder=<?php echo $ret_nome_cliente; ?>>
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Sobrenome</label>
                        <input type="text" class="form-control" placeholder= <?php echo $ret_sbnome_cliente; ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder= <?php echo $ret_endrc_cliente; ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder= <?php echo $ret_tel_cliente; ?>>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>CEP</label>
                        <input type="text" class="form-control" placeholder= <?php echo $ret_cep_cliente; ?>>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row"><!--corrigir botões de submit e alterar para mostrar form com placeholders caso não haja veículos cadastrados-->
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Placa</label>
                        <input name="placa_veiculo" type="text" class="form-control" disabled="" placeholder= <?php echo $dados_veiculos['placa']; ?>>
                      </div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Tipo</label>
                        <input name="tipo_veiculo" type="text" class="form-control" placeholder= <?php echo $dados_veiculos['tipoveiculo']; ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Modelo</label>
                        <input name="modelo_veiculo" type="text" class="form-control" placeholder= <?php echo $dados_veiculos['modelo']; ?>>
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Fabricante</label>
                        <input name="fabricante_veiculo" type="text" class="form-control" placeholder=<?php echo $dados_veiculos['fabricante']; ?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Cor</label>
                        <input name="cor_veiculo" type="text" class="form-control" placeholder= <?php echo $dados_veiculos['cor']; ?>>
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Ano</label>
                        <input name="ano_veiculo" type="text" class="form-control" placeholder= <?php echo $dados_veiculos['ano']; ?>>
                      </div>
                    </div>
                  </div>
